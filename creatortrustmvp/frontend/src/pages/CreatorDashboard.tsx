  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-4">
              ...
              <Button onClick={() => navigate('/campaigns')} variant="outline">Browse Campaigns</Button>
              <Button onClick={logout} variant="outline">Logout</Button>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h2 className="text-3xl font-bold mb-2">Welcome back, {dashboardData?.profile?.name}!</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">₦{dashboardData?.total_earnings?.toLocaleString() || 0}</div>
              <p className="text-xs text-muted-foreground">
                ₦{dashboardData?.pending_earnings?.toLocaleString() || 0} pending
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{dashboardData?.rating?.toFixed(1) || '0.0'}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{dashboardData?.profile?.engagement_rate?.toFixed(1) || '0.0'}%</div>
          ...
          <CardContent>
            {dashboardData?.campaigns?.length === 0 ? (
              <div className="text-center py-8">
                ...
                <Button onClick={() => navigate('/campaigns')} style={{ backgroundColor: '#6C63FF' }}>
                  Browse Campaigns
                </Button>
              </div>
            ) : (
